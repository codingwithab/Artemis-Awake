...
//        navigationItem.rightBarButtonItem = addButton
    ...
    func insertNewObject(_ sender: Any) {
        ...
        newAssessment.assessmentName = "Assessment One"
...
//        cell.textLabel!.text = assessment.assessmentName
//        cell.detailTextLabel!.text = assessment.moduleName
    }
    ...
    var fetchedResultsController: NSFetchedResultsController<Assessment> {
        ...
        let sortDescriptor = NSSortDescriptor(key: "assessmentName", ascending: true)
